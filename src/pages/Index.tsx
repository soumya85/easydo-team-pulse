          ...
          <div className="flex-1 p-6 bg-slate-50 overflow-auto">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="mb-6">
                ...
                <p className="text-slate-600 mt-1">Here's what's happening with your work today</p>
              </div>
                  ...
                  <Card className="bg-blue-50 border-blue-200">
                    <CardContent className="p-6">
                      <div className="flex items-center mb-4">
                        ...
                        <span className="font-medium text-slate-900">My Tasks at a Glance</span>
                      </div>
                      <div className="text-center mb-6">
                        <div className="text-4xl font-bold text-blue-600 mb-1">472</div>
                        <div className="text-sm text-slate-600">Total Pending Tasks</div>
                      </div>
                  ...
                  <Card className="bg-green-50 border-green-200">
                    <CardContent className="p-6">
                      <div className="flex items-center mb-4">
                        ...
                        <span className="font-medium text-slate-900">Meetings This Week</span>
                      </div>
                      <div className="text-center mb-6">
                        <div className="text-4xl font-bold text-green-600 mb-1">7</div>
                        <div className="text-sm text-slate-600">Scheduled Meetings</div>
                      </div>
                      <div className="space-y-3 mb-4">
                        ...
                        <div className="space-y-2">
                          <div className="bg-white p-3 rounded border">
                            <div className="font-medium text-slate-900">Weekly Team Sync</div>
                            <div className="text-sm text-slate-600 flex items-center mt-1">
                              <Clock className="w-3 h-3 mr-1" />
                              Today at 2:00 PM
                            </div>
                            <div className="text-xs text-slate-500 mt-1">5 attendees</div>
                          </div>
                          <div className="bg-white p-3 rounded border">
                            <div className="font-medium text-slate-900">Client Review Meeting</div>
                            <div className="text-sm text-slate-600 flex items-center mt-1">
                              <Clock className="w-3 h-3 mr-1" />
                              Tomorrow at 10:30 AM
                            </div>
                            <div className="text-xs text-slate-500 mt-1">John, Sarah</div>
                          </div>
                        </div>
                      </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center">
                          ...
                          <span className="font-medium text-slate-900">Recent Notes & Reminders</span>
                        </div>
                        <Badge className="bg-yellow-100 text-yellow-800 border-yellow-300">12</Badge>
                      </div>
                      ...
                      <div className="mb-4">
                        <div className="font-medium text-slate-900 mb-2">Latest Note</div>
                        <div className="bg-white p-3 rounded border text-sm text-slate-600">
                          Follow up on client feedback for the new dashboard design...
                        </div>
                      </div>
                      <div className="space-y-2">
                        ...
                        <Button variant="ghost" className="w-full text-yellow-600 hover:bg-yellow-100">
                          View All Notes
                        </Button>
                      </div>
                    </CardContent>
                  ...
                  <Card>
                    <CardContent className="p-6">
                      <div className="flex items-center mb-4">
                        ...
                        <span className="font-medium text-slate-900">My Daily Work Status</span>
                      </div>
                      
                      <div className="text-center mb-6">
                        <div className="text-3xl font-bold text-blue-600 mb-2">03:43:14 am IST</div>
                        <div className="text-sm text-slate-600">Monday 23 Jun, 2025</div>
                      </div>

                      <div className="mb-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-sm font-medium">Punch Status</span>
                        </div>
                        <div className="bg-red-50 border border-red-200 rounded p-3 mb-4">
                          <div className="font-medium text-red-800">NOT PUNCHED IN</div>
                        </div>
                      ...
                      <div className="bg-blue-50 border border-blue-200 rounded p-3">
                        <div className="flex items-center">
                          ...
                          <span className="text-sm font-medium text-blue-800">Office Hours</span>
                        </div>
                        <div className="text-sm text-blue-600 mt-1">09:00 AM To 06:00 PM</div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    <CardContent className="p-6">
                      <div className="flex items-center mb-4">
                        ...
                        <span className="font-medium text-slate-900">Monthly Attendance Summary - June 2025</span>
                      </div>
                      
                      <div className="text-center mb-4">
                        <div className="text-sm text-slate-600 mb-2">Total Days: 30 | Working Days: 22</div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div className="text-center p-3 bg-red-50 rounded">
                          ...
                          <div className="text-xs text-slate-600">Red Flags</div>
                        </div>
                      </div>
                  ...
                  <Card>
                    <CardContent className="p-6">
                      <div className="flex items-center mb-4">
                        ...
                        <span className="font-medium text-slate-900">Notice Board</span>
                      </div>
                      ...
                      <div className="space-y-3 mb-4">
                        <div className="border-l-4 border-orange-500 pl-3">
                          <div className="font-medium text-slate-900 text-sm">Holiday Notice - Diwali Celebration</div>
                        ...
                        <div className="border-l-4 border-blue-500 pl-3">
                          <div className="font-medium text-slate-900 text-sm">New Health Insurance Policy Updates</div>
                          <div className="text-xs text-slate-500 mt-1">1 day ago</div>
                          <div className="text-xs text-slate-600 mt-1">
                            Important updates regarding the company health insurance polic...
                          </div>
                        </div>
                      </div>
                  ...
                  <Card className="bg-green-50 border-green-200">
                    <CardContent className="p-6">
                      <div className="flex items-center mb-4">
                        ...
                        <div className="flex items-center">
                          <span className="font-medium text-slate-900">Salary Snapshot</span>
                          <div className="ml-2 bg-green-100 text-green-800 text-xs px-2 py-1 rounded">+2.3%</div>
                        </div>
                      </div>
                      <div className="text-center mb-4">
                        <div className="text-2xl font-bold text-green-600 mb-1">₹ 50,000.00</div>
                        <div className="text-sm text-slate-600">Last Net Pay</div>
                      ...
                      <div className="grid grid-cols-2 gap-2 mb-4 text-xs">
                        <div className="bg-white p-2 rounded text-center">
                          <div className="text-purple-600 font-bold">₹8,500</div>
                          <div className="text-slate-600">Tax Deducted</div>
                        </div>
                        <div className="bg-white p-2 rounded text-center">
                          <div className="text-orange-600 font-bold">₹2,200</div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Button variant="ghost" className="w-full text-green-600 hover:bg-green-100 text-sm">
                          View All Payslips
                        </Button>
                      </div>
                    </CardContent>
                  ...
                  <Card className="bg-yellow-50 border-yellow-200">
                    <CardContent className="p-6">
                      <div className="flex items-center mb-4">
                        ...
                        <span className="font-medium text-slate-900">My Performance</span>
                      </div>
                      ...
                      <div className="text-center mb-4">
                        ...
                        <div className="text-sm text-slate-600">Average rating from 23 task reviews</div>
                      ...
                      <div className="bg-gradient-to-r from-yellow-100 to-orange-100 p-3 rounded mb-4">
                        <div className="text-center">
                          <div className="text-orange-600 font-bold mb-1">👑</div>
                          <div className="font-medium text-orange-800">Employee of the Month</div>
                          <div className="text-sm text-orange-600">June 2025</div>
                        </div>
                      </div>
                      <Button variant="ghost" className="w-full text-yellow-600 hover:bg-yellow-100">
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center">
                          ...
                          <span className="font-medium text-slate-900">Pending Approvals</span>
                        </div>
                      ...
                      <div className="text-center mb-4">
                        ...
                        <div className="text-sm text-slate-600">Total Pending Approvals</div>
                      </div>
                      <div className="grid grid-cols-2 gap-2 mb-4 text-xs">
                        <div className="bg-white p-2 rounded text-center">
